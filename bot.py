...
from tgbot.handlers.debts.debts import register_debts_check
from tgbot.handlers.debts_check.check_depts import register_debts_check_teacher
...
def register_all_handlers(dp):
    ...
    register_debts_check(dp)
    register_debts_check_teacher(dp)
